...
class Fragment$fragmentPlaylistItem$track {
  ...
  factory Fragment$fragmentPlaylistItem$track.fromJson(
    ...
    return Fragment$fragmentPlaylistItem$track(
      ...
      artists: (l$artists as List<dynamic>)
          .map(
            (e) => Fragment$fragmentPlaylistItem$track$artists.fromJson(
  ...
  final List<Fragment$fragmentPlaylistItem$track$artists> artists;
...
abstract class CopyWith$Fragment$fragmentPlaylistItem$track<TRes> {
  ...
  TRes call({
    ...
    List<Fragment$fragmentPlaylistItem$track$artists>? artists,
  ...
  TRes artists(
    Iterable<Fragment$fragmentPlaylistItem$track$artists> Function(
      Iterable<
        CopyWith$Fragment$fragmentPlaylistItem$track$artists<
          Fragment$fragmentPlaylistItem$track$artists
        >
      >,
    )
    _fn,
  ...
  TRes call({
    ...
    Fragment$fragmentPlaylistItem$track(
      ...
      artists: artists == _undefined || artists == null
          ? _instance.artists
          : (artists as List<Fragment$fragmentPlaylistItem$track$artists>),
  ...
  TRes artists(
    ...
    artists: _fn(
      _instance.artists.map(
        (e) =>
            CopyWith$Fragment$fragmentPlaylistItem$track$artists(e, (i) => i),
      ),
    ).toList(),
  );
...
class Fragment$fragmentPlaylistItem$track$artists {
  Fragment$fragmentPlaylistItem$track$artists({
    required this.type,
    required this.position,
  ...
  factory Fragment$fragmentPlaylistItem$track$artists.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$type = json['type'];
    final l$position = json['position'];
    ...
    final l$$__typename = json['__typename'];
    return Fragment$fragmentPlaylistItem$track$artists(
      type: fromJson$Enum$TrackCreditType((l$type as String)),
      position: (l$position as int),
      person: Fragment$fragmentPlaylistItem$track$artists$person.fromJson(
  ...
  final Fragment$fragmentPlaylistItem$track$artists$person person;
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Fragment$fragmentPlaylistItem$track$artists ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$type = type;
...
extension UtilityExtension$Fragment$fragmentPlaylistItem$track$artists
    on Fragment$fragmentPlaylistItem$track$artists {
  CopyWith$Fragment$fragmentPlaylistItem$track$artists<
    Fragment$fragmentPlaylistItem$track$artists
  >
  get copyWith =>
      CopyWith$Fragment$fragmentPlaylistItem$track$artists(this, (i) => i);
}

abstract class CopyWith$Fragment$fragmentPlaylistItem$track$artists<TRes> {
  factory CopyWith$Fragment$fragmentPlaylistItem$track$artists(
    Fragment$fragmentPlaylistItem$track$artists instance,
    TRes Function(Fragment$fragmentPlaylistItem$track$artists) then,
  ) = _CopyWithImpl$Fragment$fragmentPlaylistItem$track$artists;

  factory CopyWith$Fragment$fragmentPlaylistItem$track$artists.stub(TRes res) =
      _CopyWithStubImpl$Fragment$fragmentPlaylistItem$track$artists;

  TRes call({
    Enum$TrackCreditType? type,
    int? position,
    Fragment$fragmentPlaylistItem$track$artists$person? person,
    String? $__typename,
  });
  CopyWith$Fragment$fragmentPlaylistItem$track$artists$person<TRes> get person;
}

class _CopyWithImpl$Fragment$fragmentPlaylistItem$track$artists<TRes>
    implements CopyWith$Fragment$fragmentPlaylistItem$track$artists<TRes> {
  _CopyWithImpl$Fragment$fragmentPlaylistItem$track$artists(
    this._instance,
    this._then,
  );

  final Fragment$fragmentPlaylistItem$track$artists _instance;

  final TRes Function(Fragment$fragmentPlaylistItem$track$artists) _then;
  ...
  TRes call({
    ...
    Fragment$fragmentPlaylistItem$track$artists(
      ...
      person: person == _undefined || person == null
          ? _instance.person
          : (person as Fragment$fragmentPlaylistItem$track$artists$person),
      $__typename: $__typename == _undefined || $__typename == null
          ? _instance.$__typename
          : ($__typename as String),
    ),
  ...
  CopyWith$Fragment$fragmentPlaylistItem$track$artists$person<TRes> get person {
    ...
    return CopyWith$Fragment$fragmentPlaylistItem$track$artists$person(
      local$person,
      (e) => call(person: e),
    );
  }
...
class _CopyWithStubImpl$Fragment$fragmentPlaylistItem$track$artists<TRes>
    implements CopyWith$Fragment$fragmentPlaylistItem$track$artists<TRes> {
  _CopyWithStubImpl$Fragment$fragmentPlaylistItem$track$artists(this._res);
  ...
  CopyWith$Fragment$fragmentPlaylistItem$track$artists$person<TRes>
  get person =>
      CopyWith$Fragment$fragmentPlaylistItem$track$artists$person.stub(_res);
}

class Fragment$fragmentPlaylistItem$track$artists$person {
  Fragment$fragmentPlaylistItem$track$artists$person({
    required this.id,
    required this.name,
    this.$__typename = 'Person',
  });

  factory Fragment$fragmentPlaylistItem$track$artists$person.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$id = json['id'];
    final l$name = json['name'];
    final l$$__typename = json['__typename'];
    return Fragment$fragmentPlaylistItem$track$artists$person(
      id: (l$id as String),
      name: (l$name as String),
      $__typename: (l$$__typename as String),
    );
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Fragment$fragmentPlaylistItem$track$artists$person ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$id = id;
...
extension UtilityExtension$Fragment$fragmentPlaylistItem$track$artists$person
    on Fragment$fragmentPlaylistItem$track$artists$person {
  CopyWith$Fragment$fragmentPlaylistItem$track$artists$person<
    Fragment$fragmentPlaylistItem$track$artists$person
  >
  get copyWith => CopyWith$Fragment$fragmentPlaylistItem$track$artists$person(
    this,
    (i) => i,
  );
}

abstract class CopyWith$Fragment$fragmentPlaylistItem$track$artists$person<
  TRes
> {
  factory CopyWith$Fragment$fragmentPlaylistItem$track$artists$person(
    Fragment$fragmentPlaylistItem$track$artists$person instance,
    TRes Function(Fragment$fragmentPlaylistItem$track$artists$person) then,
  ) = _CopyWithImpl$Fragment$fragmentPlaylistItem$track$artists$person;

  factory CopyWith$Fragment$fragmentPlaylistItem$track$artists$person.stub(
    TRes res,
  ) = _CopyWithStubImpl$Fragment$fragmentPlaylistItem$track$artists$person;

  TRes call({String? id, String? name, String? $__typename});
}

class _CopyWithImpl$Fragment$fragmentPlaylistItem$track$artists$person<TRes>
    implements
        CopyWith$Fragment$fragmentPlaylistItem$track$artists$person<TRes> {
  _CopyWithImpl$Fragment$fragmentPlaylistItem$track$artists$person(
    this._instance,
  ...
  final Fragment$fragmentPlaylistItem$track$artists$person _instance;

  final TRes Function(Fragment$fragmentPlaylistItem$track$artists$person) _then;
...
class _CopyWithStubImpl$Fragment$fragmentPlaylistItem$track$artists$person<TRes>
    implements
        CopyWith$Fragment$fragmentPlaylistItem$track$artists$person<TRes> {
  _CopyWithStubImpl$Fragment$fragmentPlaylistItem$track$artists$person(
    this._res,
