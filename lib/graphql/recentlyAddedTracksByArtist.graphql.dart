...
class Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks
  ...
  factory Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks.fromJson(
    ...
    return Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks(
      ...
      artists: (l$artists as List<dynamic>)
          .map(
            (e) =>
                Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists.fromJson(
                  (e as Map<String, dynamic>),
                ),
          )
          .toList(),
  ...
  final List<
    Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists
  >
  artists;
...
> {
  ...
  TRes artists(
    ...
    Function(
      Iterable<
        CopyWith$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists<
          Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists
        >
      >,
    )
...
class Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists
  ...
  factory Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists.fromJson(
    Map<String, dynamic> json,
  ) {
    ...
    final l$$__typename = json['__typename'];
    return Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists(
      type: fromJson$Enum$TrackCreditType((l$type as String)),
      position: (l$position as int),
      person:
          Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person.fromJson(
  ...
  final Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person
  person;
  ...
  bool operator ==(Object other) {
    ...
    if (other
            is! Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$type = type;
...
extension UtilityExtension$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists
    on Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists {
  CopyWith$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists<
    Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists
  >
  get copyWith =>
...
abstract class CopyWith$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists<
  TRes
> {
  factory CopyWith$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists(
    Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists
    instance,
    TRes Function(
      Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists,
    ...
    then,
  ) = _CopyWithImpl$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists;

  factory CopyWith$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists.stub(
    TRes res,
  ) = _CopyWithStubImpl$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists;

  TRes call({
    Enum$TrackCreditType? type,
    int? position,
    Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person?
    person,
    String? $__typename,
  });
  CopyWith$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person<
    TRes
  >
  get person;
}

class _CopyWithImpl$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists<
  TRes
>
    implements
        CopyWith$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists<
  ...
  final Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists
  _instance;
  ...
  TRes call({
    ...
    Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists(
      ...
      person: person == _undefined || person == null
          ? _instance.person
          : (person
                as Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person),
      $__typename: $__typename == _undefined || $__typename == null
          ? _instance.$__typename
          : ($__typename as String),
    ),
  ...
  get person {
    ...
    return CopyWith$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person(
      local$person,
      (e) => call(person: e),
    );
  }
...
class _CopyWithStubImpl$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists<
  TRes
>
    implements
        CopyWith$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists<
  ...
  >
  get person =>
      CopyWith$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person.stub(
        _res,
      );
}

class Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person
  ...
  factory Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$id = json['id'];
    final l$name = json['name'];
    final l$$__typename = json['__typename'];
    return Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person(
      id: (l$id as String),
      name: (l$name as String),
      $__typename: (l$$__typename as String),
    );
  ...
  bool operator ==(Object other) {
    ...
    if (other
            is! Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$id = id;
...
extension UtilityExtension$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person
    on
        Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person {
  CopyWith$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person<
    Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person
...
abstract class CopyWith$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person<
  TRes
> {
  factory CopyWith$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person(
    Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person
    instance,
    TRes Function(
      Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person,
    ...
    then,
  ) = _CopyWithImpl$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person;

  factory CopyWith$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person.stub(
    TRes res,
  ) = _CopyWithStubImpl$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person;

  TRes call({String? id, String? name, String? $__typename});
}

class _CopyWithImpl$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person<
  TRes
>
    implements
        CopyWith$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person<
...
class _CopyWithStubImpl$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person<
  TRes
>
    implements
        CopyWith$Query$recentlyAddedTracksByArtist$personById$recentlyAddedTracks$artists$person<
