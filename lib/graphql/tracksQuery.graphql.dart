...
class Query$tracks$tracks$content implements Fragment$fragmentTrack {
  ...
  factory Query$tracks$tracks$content.fromJson(Map<String, dynamic> json) {
    ...
    return Query$tracks$tracks$content(
      ...
      artists: (l$artists as List<dynamic>)
          .map(
            (e) => Query$tracks$tracks$content$artists.fromJson(
              (e as Map<String, dynamic>),
            ),
          )
          .toList(),
  ...
  final List<Query$tracks$tracks$content$artists> artists;
...
abstract class CopyWith$Query$tracks$tracks$content<TRes> {
  ...
  TRes call({
    ...
    List<Query$tracks$tracks$content$artists>? artists,
  ...
  TRes artists(
    Iterable<Query$tracks$tracks$content$artists> Function(
      Iterable<
        CopyWith$Query$tracks$tracks$content$artists<
          Query$tracks$tracks$content$artists
        >
      >,
    )
    _fn,
  ...
  TRes call({
    ...
    Query$tracks$tracks$content(
      ...
      artists: artists == _undefined || artists == null
          ? _instance.artists
          : (artists as List<Query$tracks$tracks$content$artists>),
  ...
  TRes artists(
    ...
    artists: _fn(
      _instance.artists.map(
        (e) => CopyWith$Query$tracks$tracks$content$artists(e, (i) => i),
      ),
    ).toList(),
  );
...
class Query$tracks$tracks$content$artists
  ...
  factory Query$tracks$tracks$content$artists.fromJson(
    Map<String, dynamic> json,
  ) {
    ...
    final l$$__typename = json['__typename'];
    return Query$tracks$tracks$content$artists(
      type: fromJson$Enum$TrackCreditType((l$type as String)),
      position: (l$position as int),
      person: Query$tracks$tracks$content$artists$person.fromJson(
  ...
  final Query$tracks$tracks$content$artists$person person;
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$tracks$tracks$content$artists ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$type = type;
...
extension UtilityExtension$Query$tracks$tracks$content$artists
    on Query$tracks$tracks$content$artists {
  CopyWith$Query$tracks$tracks$content$artists<
    Query$tracks$tracks$content$artists
  >
  get copyWith => CopyWith$Query$tracks$tracks$content$artists(this, (i) => i);
}

abstract class CopyWith$Query$tracks$tracks$content$artists<TRes> {
  factory CopyWith$Query$tracks$tracks$content$artists(
    Query$tracks$tracks$content$artists instance,
    TRes Function(Query$tracks$tracks$content$artists) then,
  ) = _CopyWithImpl$Query$tracks$tracks$content$artists;

  factory CopyWith$Query$tracks$tracks$content$artists.stub(TRes res) =
      _CopyWithStubImpl$Query$tracks$tracks$content$artists;

  TRes call({
    Enum$TrackCreditType? type,
    int? position,
    Query$tracks$tracks$content$artists$person? person,
    String? $__typename,
  });
  CopyWith$Query$tracks$tracks$content$artists$person<TRes> get person;
}

class _CopyWithImpl$Query$tracks$tracks$content$artists<TRes>
    implements CopyWith$Query$tracks$tracks$content$artists<TRes> {
  _CopyWithImpl$Query$tracks$tracks$content$artists(this._instance, this._then);

  final Query$tracks$tracks$content$artists _instance;

  final TRes Function(Query$tracks$tracks$content$artists) _then;
  ...
  TRes call({
    ...
    Query$tracks$tracks$content$artists(
      ...
      person: person == _undefined || person == null
          ? _instance.person
          : (person as Query$tracks$tracks$content$artists$person),
      $__typename: $__typename == _undefined || $__typename == null
          ? _instance.$__typename
          : ($__typename as String),
    ),
  ...
  CopyWith$Query$tracks$tracks$content$artists$person<TRes> get person {
    ...
    return CopyWith$Query$tracks$tracks$content$artists$person(
      local$person,
      (e) => call(person: e),
    );
  }
...
class _CopyWithStubImpl$Query$tracks$tracks$content$artists<TRes>
    implements CopyWith$Query$tracks$tracks$content$artists<TRes> {
  _CopyWithStubImpl$Query$tracks$tracks$content$artists(this._res);
  ...
  CopyWith$Query$tracks$tracks$content$artists$person<TRes> get person =>
      CopyWith$Query$tracks$tracks$content$artists$person.stub(_res);
}

class Query$tracks$tracks$content$artists$person
    implements Fragment$fragmentTrack$artists$person {
  Query$tracks$tracks$content$artists$person({
    required this.id,
    required this.name,
    this.$__typename = 'Person',
  });

  factory Query$tracks$tracks$content$artists$person.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$id = json['id'];
    final l$name = json['name'];
    final l$$__typename = json['__typename'];
    return Query$tracks$tracks$content$artists$person(
      id: (l$id as String),
      name: (l$name as String),
      $__typename: (l$$__typename as String),
    );
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$tracks$tracks$content$artists$person ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$id = id;
...
extension UtilityExtension$Query$tracks$tracks$content$artists$person
    on Query$tracks$tracks$content$artists$person {
  CopyWith$Query$tracks$tracks$content$artists$person<
    Query$tracks$tracks$content$artists$person
  >
  get copyWith =>
      CopyWith$Query$tracks$tracks$content$artists$person(this, (i) => i);
}

abstract class CopyWith$Query$tracks$tracks$content$artists$person<TRes> {
  factory CopyWith$Query$tracks$tracks$content$artists$person(
    Query$tracks$tracks$content$artists$person instance,
    TRes Function(Query$tracks$tracks$content$artists$person) then,
  ) = _CopyWithImpl$Query$tracks$tracks$content$artists$person;

  factory CopyWith$Query$tracks$tracks$content$artists$person.stub(TRes res) =
      _CopyWithStubImpl$Query$tracks$tracks$content$artists$person;

  TRes call({String? id, String? name, String? $__typename});
}

class _CopyWithImpl$Query$tracks$tracks$content$artists$person<TRes>
    implements CopyWith$Query$tracks$tracks$content$artists$person<TRes> {
  _CopyWithImpl$Query$tracks$tracks$content$artists$person(
    this._instance,
    this._then,
  );

  final Query$tracks$tracks$content$artists$person _instance;

  final TRes Function(Query$tracks$tracks$content$artists$person) _then;
...
class _CopyWithStubImpl$Query$tracks$tracks$content$artists$person<TRes>
    implements CopyWith$Query$tracks$tracks$content$artists$person<TRes> {
  _CopyWithStubImpl$Query$tracks$tracks$content$artists$person(this._res);
